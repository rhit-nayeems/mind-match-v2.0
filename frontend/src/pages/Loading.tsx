  ...
  return (
    <div className="grid min-h-[60vh] place-items-center">
      <div className="surface w-full max-w-xl p-8 text-center">
        <div className="code-label text-[#A8C4EC]/80">running recommendation graph</div>
        ...
        <div className="mt-6 h-2 overflow-hidden rounded-full border border-[#A8C4EC]/20 bg-[#A8C4EC]/[0.1]">
